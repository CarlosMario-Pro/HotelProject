...
export function Layout({ children }) {
    return (
        <div>
                ...
                <div>
                    <nav className={styles.menuNavBar}>
                        <ol className={styles.menu}>
                            <la><Link href="/whoWeAre">QUIENES SOMOS</Link></la>
                            <la className={styles.blockMenu}>HOTEL
                                <MdOutlineKeyboardArrowDown />
                                <ul>
                                    <li className={styles.optionsMenu}><Link href="/welcome">Bienvenida</Link></li>
                                    <li className={styles.optionsMenu}><Link href="/services">Servicios</Link></li>
                                    <li className={styles.optionsMenu}><Link href="/galery">Galeria</Link></li>
                                    ...
                                    <li className={styles.optionsMenu}><Link href="/localization">Localización</Link></li>
                                </ul>
                            </la>
                            <la> HABITACIONES
                                <MdOutlineKeyboardArrowDown />
                                <ul>
                                    <li className={styles.optionsMenu}><Link href="/roomDoubleStandard">ESTANDAR DOBLE</Link></li>
                                    <li className={styles.optionsMenu}><Link href="/roomDoubleTop">DEBLE SUPERIOR</Link></li>
                                    <li className={styles.optionsMenu}><Link href="/roomDoubleTwin">TWIN SUPERIOR</Link></li>
                                    <li className={styles.optionsMenu}><Link href="/roomJuniorSuite">JUNIOR SUITE</Link></li>
                                    <li className={styles.optionsMenu}><Link href="/roomMultiple">MULTIPLE</Link></li>
                                </ul>
                            </la>
                            <la><Link href="/offers&Plans">OFERTAS</Link></la>
                            <la><Link href="/contact">CONTACTAR</Link></la>
                            <la><Link href="/bookings">RESERVAS</Link></la>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <Link href="/yourOpinion">DEJANOS TU OPINION</Link>

            <div>
                <footer>
                    <ol>
                        <la><Link href="/whoWeAre">RESEÑA</Link></la>
                        <li className={styles.optionsMenu}><Link href="https://www.hotelrosalesneiva.com/docs/HOTEL_ROSALES_PROTOCOLO_COVID_19.pdf" target="_blank" rel="noopener noreferrer">PROTOCOLO DE BIOSEGURIDAD</Link></li>
                        <la><Link href="/contact">CONTACTAR</Link></la>
                        <li className={styles.optionsMenu}><Link href="https://www.hotelrosalesneiva.com/docs/Certificacion_RUE.pdf" target="_blank" rel="noopener noreferrer">RNT</Link></li>

                        <la>NEWSLETTER</la>
                        <la><Link href="/legalPolity">TEXTOS LEGALES</Link></la>
                        <la><Link href="/polityCookies">POLITICA DE COOKIES</Link></la>
                    </ol>
                </footer>
            </div>
        </div>
